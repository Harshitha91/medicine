...
export default class Rating extends PureComponent {
  ...
  handleFieldChange = (value) => {
    console.log('wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww', value);
        ...
        <View style={styles.inputElementWrapper}>
          <View style={styles.inputSubWrapper}>
            <View style={{ flexDirection: 'row' }}>
                <ButtonGroupButton
                  style={Styles.btn}
                  onPress={() => this.handleFieldChange(null)}
                >
                    <Text
                        type='medium'
                ...
                <View>
                  <AirbnbRating
                      ...
                      starContainerStyle={{ height: moderateScale(50), top: Platform.OS === 'android' ? moderateScale(-58) : moderateScale(10)}}
                  />
                </View>
            </View>
          </View>
