...
export const ComplainListItem = (props) => {
    ...
    >
      <View>
        <View style={{ flexDirection: "column" }}>
            ...
            <View style={{ flex: 80 }}>
              ...
              >
                <View style={{ top: moderateScale(0) }}>
                  ...
                  >
                    ID:{" "}
                    <Text style={{ color: "#ff2020" }}>{"fdsdfsdfdsf"}</Text>
                  </Text>
                  <Text
                    style={{ marginTop: moderateScale(2), color: "#bcbcbc" }}
                  >
                    Created by:{" "}
                    <Text style={{ color: "#000" }}>{"dfdfdfdsfdsf"}</Text>
                  </Text>
                  {/* <Text style={{ marginTop: moderateScale(5), color: '#999', maxHeight: 33 }}>{data.description}</Text> */}
                  <Text
                    style={{ marginTop: moderateScale(2), color: "#bcbcbc" }}
                  >
                    Facility:{" "}
                    <Text style={{ color: "#000" }}>{"cvxcvcxvxcvxcv"}</Text>
                  </Text>
                </View>
              </View>
            </View>
          ...
          >
            <Text numberOfLines={2}>{"fghfghfg"}</Text>
          </View>
