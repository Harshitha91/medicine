...
export default class Book extends React.Component {
  ...
  render() {
    ...
    console.log(
      "OOOOOOOOOOODDDDDDDDAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
      data
    );
            ...
            <View>
              <View style={{ flex: 1, flexDirection: "row" }}>
                ...
                >
                  ...
                  >
                    {formattedData.doctor.firs_name +
                      " " +
                      formattedData.doctor.last_name}
                  </Text>
                </View>
              </View>
              <View
              ...
              >
                ...
                >
                  {formattedData.channeling_center.name}
                </Text>
              </View>
...
const mapStateToProps = (state, ownProps) => {
  return {
    ...
    data: state.doctor.channels,
  };
};

export const BookContainer = connect(mapStateToProps, {
  onFieldChange,
  setState,
  resetForms,
  setFormFields,
