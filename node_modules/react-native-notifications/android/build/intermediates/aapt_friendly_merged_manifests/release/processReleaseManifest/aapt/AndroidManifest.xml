...
<!--          A proxy-service that gives the library an opportunity to do some work before launching/resuming the actual application task. -->
        ...
        <service android:name="com.wix.reactnativenotifications.gcm.FcmInstanceIdListenerService" >
            <intent-filter>
        ...
        <service
            android:name="com.wix.reactnativenotifications.gcm.FcmInstanceIdRefreshHandlerService"
